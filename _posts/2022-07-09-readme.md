...
### Icons
For categories I use svg-icons in `images`. ?he icon is automatically assigned to the post by its category. The icon name must be `category_name.svg`.
